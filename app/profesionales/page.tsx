        ...
        <div className="container px-4">
          ...
          {filteredProfessionals.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">Aún no hay profesionales registrados en la plataforma.</p>
              <p className="text-gray-400 text-sm mt-2">Los profesionales aparecerán aquí una vez que se registren.</p>
            </div>
          )}
        </div>
      </section>
